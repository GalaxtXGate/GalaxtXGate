...
import 'package:galaxyxgate/features/crew/presentation/widget/icon_text_row.dart';

class CrewsGrid extends StatelessWidget {
  final List<CrewModel>? crewList;

  const CrewsGrid({super.key, required this.crewList});
