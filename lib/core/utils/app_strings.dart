class AppStrings {
  ...
  static const String weProvide = "We Provide";
  static const String beUpdatedWithAllTheRocketsCapsulesCrew =
      "Be updated with all the Rockets, \ncapsules, crew and more";
  static const String reliableInformation = "Reliable Information";
  static const String galaxyXGate = "Galaxy X Gate";
  static const String yourGuideToKnowingAllAboutSpaceXLaunches =
      "Your guide to knowing all about \nspace X launches";
  static const String letsKnowMore = "Let’s Know More";
  static const String getStartedNow = "Get Started Now";
  static const String signInOrCreateAccount = "Sign in or create account";
  ...
  static const String knowAboutActiveCapsulesTheirCountryAndMore =
      "know about active capsules, their country and more";
  static const String crew = "Crew";
  static const String signUp = "Sign Up";
  static const String createYourAccountToContinueExploring =
  ...
  static const String getBackInToContinueExploring =
      "get back in to continue exploring";
  static const String addYourProfilePicture = "Add your profile picture";
  static const String youCanChangeYourPictureAtAnytime =
